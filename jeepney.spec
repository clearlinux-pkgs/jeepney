...
%prep
%setup -q -n jeepney-0.7.0
cd %{_builddir}/jeepney-0.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626103106
...
cp %{_builddir}/jeepney-0.7.0/LICENSE %{buildroot}/usr/share/package-licenses/jeepney/b2f7e71b77f14f21cd693e1c6fbe7236a8deac5f
