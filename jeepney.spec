...
Source0  : https://files.pythonhosted.org/packages/9f/23/4a234a61e9c3352e4165b2394da877903fd0c680ba0045e5abb3268da3e1/jeepney-0.5.0.tar.gz
...
%prep
%setup -q -n jeepney-0.5.0
cd %{_builddir}/jeepney-0.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605050854
...
cp %{_builddir}/jeepney-0.5.0/LICENSE %{buildroot}/usr/share/package-licenses/jeepney/b2f7e71b77f14f21cd693e1c6fbe7236a8deac5f
